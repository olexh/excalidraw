...
export declare const exportToCanvas: (elements: readonly NonDeletedExcalidrawElement[], appState: AppState, files: BinaryFiles, { exportBackground, exportPadding, viewBackgroundColor, elementBounds, }: {
    exportBackground: boolean;
    exportPadding?: number | undefined;
    elementBounds?: ExcalidrawElement | undefined;
