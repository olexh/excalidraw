...
const restoreElement = (
    ...
    switch (element.type) {
        ...
        case "arrow": {
            ...
            return restoreElementWithProperties(element, {
                type:
                    (element.type as ExcalidrawElement["type"] | "draw") ===
                    "draw"
                        ? "line"
                        : element.type,
            ...
            (
                ...
                if (boundElement && !boundIds.has(binding.id)) {
                    ...
                    if (
                        ...
                        (
                            boundElement as Mutable<ExcalidrawTextElement>
...
const repairBoundElement = (
    ...
    if (
        ...
        !container.boundElements.find(
            (binding) => binding.id === boundElement.id,
        )
    ) {
        // copy because we're not cloning on restore, and we don't want to mutate upstream
        const boundElements = (
    ...
    const restoredElements = (elements || []).reduce((elements, element) => {
        ...
        if (element.type !== "selection" && !isInvisiblySmallElement(element)) {
            ...
            if (migratedElement) {
                ...
                if (
                    localElement &&
                    localElement.version > migratedElement.version
                ) {
